...
C    26 = CALIFORNIA LIVE OAK (LO)        QUERCUS AGRIFOLIA
...
C    45 = BLACK COTTONWOOD (CW)           POPULUS BALSAMIFERA ssp. 
C                                         trichocarpa
...
C    50 = REDWOOD (RW)                    SEQUIOA SEMPERVIRENS
C----------
      DATA JSP /
...
C  GIANT SEQUOIA VALUE (#23) SAME AS REDWOOD (#50)
C
      DATA SIGMAR/
...
C----------
C   LOAD ARRAY HTT1(MAXSP,9) WITH SINGLE DATA STATEMENT.
C   ORDER OF LOAD IS ROWS 1-50, COL 1; ROWS 1-50, COL 2; ROWS 1-50, COL 3...
C
      DATA HTT1/ 450*0./
