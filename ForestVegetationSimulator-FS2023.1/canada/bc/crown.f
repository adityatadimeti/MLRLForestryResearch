...
C  DATA CRSD/6.35/ ! assigned by species below
...
C----------
   ...
   51   CONTINUE
*** THERE IS A BUG HERE THAT FAILS TO CALCULATE ICR
*** SOLVE LATER. DR 13-AP-2021
!C----------  
...
C  IS CALCULATED UNTIL THE TREE ATTAINS THESE LIMITS
C----------
   58 CONTINUE
