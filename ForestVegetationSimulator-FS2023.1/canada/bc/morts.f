...
C     ANNUAL PERCENT MORTALITY: 0.153 = 0.153%/YR = 0.00153/YR
C
...
C----------
   ...
   29     CONTINUE
C----------
C  APPLY 60 PERCENT OF NI RATE FOR LM,PY,AS,CO,MM,PB,OH. - New in NI
C  DO NOT APPLY TO BC
C----------  
...
C  TIME RESOLUTION.  ITYPE IS A HABITAT INDEX THAT IS ASSIGNED IN
C  **BECSET** .
C----------
        IPT=IPDG(ITYPE,IFOR)
        POTEN=POT(IPT)
