...
C  REDWOOD DOES NOT USE PREDICTION FROM SMHGDG ROUTINE. REDWOOD
C  GETS A VALUE OF 2.0 ASSIGNED TO HHT AS IS DONE IN CA VARIANT.
C
      ID=0
      HHT=1.0
      DD=.1

C  DETERMINE HHT CALCULATION BASED ON SPECIES
      IF(I .EQ. 17) THEN
        HHT = 2.0
