...
C  TO DO SO. IWHO, PARAMETER 1, HAS NO AFFECT ON XMAXPT ARRAY VALUES.
C
      CALL SDICAL (0, XMAX)
C---------
...
C  AK VARIANT DOES NOT ESTIMATE TREE AGE. IF AGE IS PROVIDED ON INPUT
C  TREE RECORD, IT WILL BE INCREMENTED. PLANTED AND REGEN TREES DO NOT
C  GET AGE ASSIGNMENTS EITHER.
C----------
